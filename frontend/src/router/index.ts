...
const routes = [
  ...
  { path: '/shared', name: 'shared', component: () => import('../features/workspace/FeaturePage.vue'), meta: { auth: true, title: '共享空间' } },
  ...
  { path: '/search', name: 'search', component: () => import('../features/workspace/FeaturePage.vue'), meta: { auth: true, title: '全局搜索' } },
